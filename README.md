...
# Build.
xcp-ng-dev 8.2 container build xapi/
```
...
```sh
xcp-ng-dev -n --enablerepo=epel 8.3 container build --rpmbuild-stage=p
```
...
```sh
xcp-ng-dev 8.2 container -v /work/code:/mnt/repos shell
```
